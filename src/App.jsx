  ...
  return (
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-5xl animate-fade-in-down">
      <div className="warm-glass rounded-full px-6 py-4 flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-yellow-400 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-orange-500/20 transform rotate-3">
            A
          </div>
        ...
        >
          ...
          <h1 className="font-display text-6xl md:text-8xl font-extrabold leading-[1.1] mb-8 text-gray-900 max-w-5xl mx-auto tracking-tight">
            ...
            <span className="relative inline-block text-gradient-sun">
              warmth
              <svg
                className="absolute w-full h-4 -bottom-2 left-0 text-yellow-400 -z-10 opacity-60"
                viewBox="0 0 100 10"
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-12 leading-relaxed max-w-3xl mx-auto font-medium">
            Apricity Studio blends design, code, and visuals to build warm,
          ...
          {marqueeServices.map((service, index) => (
            ...
            >
              ...
              <div className="relative w-20 h-20 flex items-center justify-center">
                ...
                <div
                  className={`w-16 h-16 rounded-full bg-gradient-to-br from-orange-100 to-yellow-100 flex items-center justify-center shadow-sm relative z-10 group-hover:scale-110 transition-transform duration-300`}
                >
                  {service.icon}
                </div>
              </div>

              <h3 className="text-2xl font-bold text-gray-800 font-display group-hover:text-orange-600 transition-colors">
                {service.title}
              </h3>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-24">
          ...
          <p className="text-xl text-gray-600 font-medium">
            A clear journey from dawn to day.
          </p>
        </div>
            ...
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-display font-bold text-xl mb-2 text-gray-800 group-hover:text-orange-600 transition-colors">
                    {step.title}
                  </h3>
          ...
          {projects.map((project, index) => {
            ...
            return (
              <div
                ...
                className={`warm-glass rounded-[2rem] p-5 hover:-translate-y-3 transition-all duration-500 group hover:shadow-sun ${
                  isVisible
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-10"
                }`}
              >
                ...
                <div className="px-2 pb-4">
                  <h3 className="text-2xl font-bold text-gray-800 font-display mb-3 group-hover:text-orange-600 transition-colors">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="inline-flex px-4 py-1.5 rounded-full bg-orange-50 border border-orange-100 text-xs font-bold text-orange-600 uppercase tracking-wide hover:bg-orange-100 transition-colors"
                      >
                        {tag}
                      </span>
                    ))}
  ...
  return (
    <section id="about" className="py-32 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div
          ref={ref}
          className={`warm-glass rounded-[3rem] p-8 md:p-20 transition-all duration-1000 ease-out relative overflow-hidden ${
            isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
          }`}
        >
          {/* Background Blobs */}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="bg-white/40 rounded-3xl border border-white/60 p-10 text-center backdrop-blur-md shadow-xl">
              <div className="grid grid-cols-2 gap-10">
                <div>
                  <div className="text-5xl font-bold text-orange-500 mb-2 font-display">
                    50+
                  </div>
                ...
                <div>
                  <div className="text-5xl font-bold text-yellow-500 mb-2 font-display">
                    5+
                  </div>
                  <div className="text-gray-500 font-bold text-xs uppercase tracking-widest">
                    Cycles
        ...
        >
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold mb-6 text-gray-900">
              Establish <span className="text-orange-500">Uplink</span>
            </h2>
            <p className="text-xl text-gray-600 font-light">
          ...
          <div className="grid md:grid-cols-2 gap-16 max-w-5xl mx-auto items-start">
            <div className="flex flex-col justify-center warm-glass p-10 rounded-[2.5rem]">
              ...
              <a
                ...
                className="text-orange-500 font-bold text-2xl hover:text-orange-400 transition-colors break-words"
              >
            ...
            <form
              ...
              className="warm-glass p-10 rounded-[2.5rem]"
            >
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    } px-4 py-3 bg-white/50 text-gray-800 focus:outline-none focus:bg-white focus:border-orange-500 focus:shadow-sm transition-all font-medium placeholder-gray-400`}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-xl border ${
                      errors.message ? "border-red-400" : "border-orange-200"
                    } px-4 py-3 bg-white/50 text-gray-800 focus:outline-none focus:bg-white focus:border-orange-500 focus:shadow-sm transition-all min-h-[140px] font-medium placeholder-gray-400`}
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-yellow-400 rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-orange-500/30 backdrop-blur-sm">
                A
              </div>
              <span className="font-display font-bold text-2xl text-white shadow-black drop-shadow-md">
                Apricity
              </span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              We build digital products with warmth, precision, and a touch of
              Himalayan spirit.
            </p>
            <div className="inline-block px-4 py-2 rounded-lg bg-white/10 border border-white/20 backdrop-blur-md">
              <p className="text-orange-300 font-bold tracking-widest uppercase text-xs">
                Slogan
              </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-bold text-lg mb-6 text-orange-400 uppercase tracking-wider">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li className="flex items-center gap-3">
                <span className="text-xl">📧</span>
                <a
                  href="mailto:hello@apricity.com"
